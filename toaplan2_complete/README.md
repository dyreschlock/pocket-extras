...
Check inside the following locations:
/Cores/coinop.Toaplan_V2_Rotated/
/Cores.coinop.Toaplan_V2_Standard/

## Note #2

I modified the MRA files slightly by changing the RBF to toaplan2_c. All of the JSON files for the core are expected the full set name, rather than a truncated 8 character name. So, you won't be able to do a straight ROM copy from your current cores.
